      ...
      <Card className="shadow-2xl border-0 sticky bottom-4 bg-white/95 backdrop-blur-md">
        <CardContent className="p-6">
          ...
          <div className="flex gap-4">
            ...
            <Button
              className={`flex-1 text-white bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 shadow-lg hover:shadow-xl transition-all duration-300 ${allAnswered ? 'hover:scale-[1.02]' : ''}`}
